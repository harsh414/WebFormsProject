<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DepartmentDbAccess.aspx.cs" Inherits="WebFormsProject.DataAccess.DepartmentDbAccess" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hr />
    <asp:GridView ID="gvDept" runat="server" BackColor="black" 
    ...
    GridLines="Vertical" AutoGenerateColumns="False" 
        ...
        OnSelectedIndexChanged="gvDept_SelectedIndexChanged" CellSpacing="2" 
         PageSize="2">
